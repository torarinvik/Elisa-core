...
- `static def` declares a compile-time-only function; static assertions and static expression statements may call simple static functions with compile-time locals, assignments, and conditionals, while runtime calls are rejected
