...
func (s *functionState) emitCloneValue(sourceValue C.LLVMValueRef, sourceType semantic.Type, targetType semantic.Type, name string) (C.LLVMValueRef, error) {
	...
	case *semantic.BuiltinType, *semantic.IDType, *semantic.AddressSpaceType, *semantic.ConstEnumType, *semantic.ErrorSetType, *semantic.NullType, *semantic.DStrType, *semantic.SViewType:
