...
func TestRunCLICompilesFixtureProgramsToLLVM(t *testing.T) {
	...
	fixtures := []struct {
		...
		},
		{
			...
			checks: []string{
				"%Thread__i64 = type { i64, ptr }",
				"%Task__i64 = type { i64, ptr }",
				"%ThreadPool = type { ptr }",
				...
				"define %Thread__i64 @typed_thread_spawn(i64",
				"define %Thread__i64 @typed_thread_spawn_permissioned(i64",
				"define i64 @typed_thread_join(%Thread__i64",
				...
				"define %Thread__i64 @spawn1__i64__i64(",
				"define i64 @join__i64(",
				"define void @detach__i64(",
				"define %Task__i64 @pool_submit1__i64__i64(",
