...
func specializeExportFuncType(a *Analyzer, base *FuncType, bindings map[string]Type) *FuncType {
	...
	return &FuncType{
		...
		ReturnRegion:                specialized.ReturnRegion,
		...
		ReturnProvenance:            cloneRegionRefState(specialized.ReturnProvenance),
		ReturnProvenanceKnown:       specialized.ReturnProvenanceKnown,
