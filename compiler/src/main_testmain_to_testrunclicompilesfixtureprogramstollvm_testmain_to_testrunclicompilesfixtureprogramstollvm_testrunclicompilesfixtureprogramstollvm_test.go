	...
	fixtures := []struct {
		...
		},
		{
			...
			checks: []string{
				...
				"call void @ovl__push__mutable_DArrayBuilder_T__push__i32(",
				"call i32 @ovl__get__DArrayBuilder_T__get__i32(",
				"call %DynArray__i32 @ovl__finish__DArrayBuilder_T__finish__i32(",
			},
		},
		{
