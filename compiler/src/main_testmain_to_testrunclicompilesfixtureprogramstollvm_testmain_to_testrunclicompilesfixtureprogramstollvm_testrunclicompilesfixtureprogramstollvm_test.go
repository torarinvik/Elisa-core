	...
	fixtures := []struct {
		...
		},
		{
			...
			checks: []string{
				...
				"define i1 @ovl__has__SymbolTable_K_T__has__cstr_key_shape__FixtureSymbol(",
				"define i64 @ovl__count__SymbolTable_K_T__count__cstr_key_shape__FixtureSymbol(",
		...
		},
		{
			...
			checks: []string{
				...
				"call void @push__i32(",
				"call i32 @get__i32(",
				"call %DynArray__i32 @finish__i32(",
			},
		},
		{
		...
		},
		{
			...
			checks: []string{
				...
				"define void @notify_one(ptr",
				"define void @notify_all(ptr",
