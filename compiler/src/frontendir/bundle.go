...
func registerBundleTypes() {
	registerBundleTypesOnce.Do(func() {
		...
		gob.Register(&ast.CharsetDecl{})
		gob.Register(&ast.KeywordMapDecl{})
		gob.Register(&ast.KeywordMapEntry{})
		...
		gob.Register(&ast.StaticAssertBlockDecl{})
		gob.Register(&ast.StaticGenerateDecl{})
		gob.Register(&ast.StaticGenerateEmitDecl{})
		gob.Register(&ast.StaticGenerateForDecl{})
		gob.Register(&ast.StaticGenerateIfDecl{})
		...
		gob.Register(&ast.WhereRefinementTypeExpr{})
		...
		gob.Register(&ast.AssertHoleStmt{})
		gob.Register(&ast.StaticAssertBlockStmt{})
		gob.Register(&ast.StaticBlockStmt{})
