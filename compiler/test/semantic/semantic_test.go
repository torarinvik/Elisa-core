...
`
	...
	all := strings.Join(errs, "\n")
	if !strings.Contains(all, "return type expects DArray[void&, row], got DArray[void&, shape_out#") || !strings.Contains(all, "note: ctx_stage1rt_list_push returns a fresh logical shape for shape_out") {
