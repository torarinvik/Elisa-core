...
int main(void) {
    ...
    assert(json_parser_value_object_len(&root_value) == 5);
    ...
    assert(strcmp((char*)value_buf, "Ada") == 0);
    assert(json_parser_value_index(&array_root_value, 2u, &nested_array_value) == 1);
    assert(json_parser_value_array_len(&nested_array_value) == 2);
    assert(json_parser_value_index_array_len(&array_root_value, 2u) == 2);
    assert(json_parser_value_index(&array_root_value, 3u, &nested_object_value) == 1);
    assert(json_parser_value_object_len(&nested_object_value) == 1);
    assert(json_parser_value_index_object_len(&array_root_value, 3u) == 1);
